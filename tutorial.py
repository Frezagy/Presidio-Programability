...
# Create the Tenant
tenant = Tenant('AF_Prog_Test')

# Create the Application Profile
app = AppProfile('ASA', tenant)

# Create the EPG
epg = EPG('WEB_FARM', app)
epg2 = EPG('USERS', app)


# Create a Context and BridgeDomain
context = Context('INTERNAL', tenant)
bd1 = BridgeDomain('WEB_Inside', tenant)
bd1.add_context(context)
bd2 = BridgeDomain('USER_Inside', tenant)
